...
class SegNet_deep(nn.Module):
    def __init__(self,input_nbr,label_nbr):
        ...
        self.bn51 = nn.BatchNorm2d(1024, momentum= batchNorm_momentum)
        self.conv52 = nn.Conv2d(1024, 1024, kernel_size=3, padding=1)
        self.bn52 = nn.BatchNorm2d(1024, momentum= batchNorm_momentum)
        self.conv53 = nn.Conv2d(1024, 1024, kernel_size=3, padding=1)
        self.bn53 = nn.BatchNorm2d(1024, momentum= batchNorm_momentum)

        self.conv61 = nn.Conv2d(1024, 1024, kernel_size=3, padding=1)
        self.bn61 = nn.BatchNorm2d(1024, momentum= batchNorm_momentum)
        self.conv62 = nn.Conv2d(1024, 1024, kernel_size=3, padding=1)
        self.bn62 = nn.BatchNorm2d(1024, momentum= batchNorm_momentum)
        self.conv63 = nn.Conv2d(1024, 1024, kernel_size=3, padding=1)
        self.bn63 = nn.BatchNorm2d(1024, momentum= batchNorm_momentum)

        self.conv63d = nn.Conv2d(1024, 1024, kernel_size=3, padding=1)
        self.bn63d = nn.BatchNorm2d(1024, momentum= batchNorm_momentum)
        self.conv62d = nn.Conv2d(1024, 1024, kernel_size=3, padding=1)
        self.bn62d = nn.BatchNorm2d(1024, momentum= batchNorm_momentum)
        self.conv61d = nn.Conv2d(1024, 1024, kernel_size=3, padding=1)
        self.bn61d = nn.BatchNorm2d(1024, momentum= batchNorm_momentum)

        self.conv53d = nn.Conv2d(1024, 1024, kernel_size=3, padding=1)
        self.bn53d = nn.BatchNorm2d(1024, momentum= batchNorm_momentum)
        self.conv52d = nn.Conv2d(1024, 1024, kernel_size=3, padding=1)
        self.bn52d = nn.BatchNorm2d(1024, momentum= batchNorm_momentum)
