...
Modify SegNet for hyperspectral by replacing max-pool 
    and unpool with upsampling in some cases
'''

class SegNet_hs(nn.Module):
    """
    Class to implement segnet model for hyper-spectral data
    """
