...
def draw_paved_road_mask(tiff_img, imperv_shp):
    ...
    *base, leaf = tiff_img.split("/")
    ...
    mask_img = "/".join(["/".join(base), "masks_" + leaf])    # "lasfiles/48837_7/paved_rd_mask_48837_7_sat.tif"

    DXFs = ['BUILDING', 'RUIN', 'SIDEWALK', 'PAVED-ROAD', 'PAVED-DRIVEWAY', 'UNPAVED-DRIVEWAY', 'PAVED-PARKING', 'UNPAVED-PARKING', 'WATERBODY']
