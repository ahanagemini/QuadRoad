...
def compute_metric(params, fname="/home/ahana/road_data/valid.txt"):
    ...
    for tile in tiles:
        ...
        res1_2 = numpy.multiply(res1_2,params[4])
        res2_2 = numpy.multiply(res2_2,params[5])
        res3_2 = numpy.multiply(res3_2,params[6])
        res4_2 = numpy.multiply(res4_2,params[7])
        res1_res2 = numpy.multiply(res1_res2,params[8])
        res1_res3 = numpy.multiply(res1_res3,params[9])
        res1_res4 = numpy.multiply(res1_res4,params[10])
        res2_res3 = numpy.multiply(res2_res3,params[11])
        res2_res4 = numpy.multiply(res2_res4,params[12])
        res3_res4 = numpy.multiply(res3_res4,params[13])

        #target = misc.imread(gt_dir + tile + ".png")
        #if len(params) == 5:
        combp_temp = numpy.add(res1,res2)
        combp_temp = numpy.add(combp_temp,res3)
        combp_temp = numpy.add(combp_temp,res4)
        combp_temp = numpy.add(combp_temp,res1_2)
        combp_temp = numpy.add(combp_temp,res2_2)
        combp_temp = numpy.add(combp_temp,res3_2)
        combp_temp = numpy.add(combp_temp,res4_2)
        combp_temp = numpy.add(combp_temp,res1_res2)
        combp_temp = numpy.add(combp_temp,res1_res3)
        combp_temp = numpy.add(combp_temp,res1_res4)
        combp_temp = numpy.add(combp_temp,res2_res3)
        combp_temp = numpy.add(combp_temp,res2_res4)
        combp = numpy.add(combp_temp,res3_res4)
