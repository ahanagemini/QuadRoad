...
R: class 0 probability in 17 class
G: class 1 probability in 17 class
B: class 12 probability in 17 class
'''

FLAGS = tf.app.flags.FLAGS

tf.app.flags.DEFINE_string('image_folder',
                           '/home/ahana/road_data/confuse_17_3/',
...
tf.app.flags.DEFINE_string(
    'output_dir',
    '/home/ahana/road_data/tfrecord/new_tf/confusion3',
