...
flags.DEFINE_string('purpose', 'vis',
                    'eval for prediction, vis for softmax of label_no class')

flags.DEFINE_string('folder_name', 'results',
...
flags.DEFINE_integer('label_no', 0,
                    'label whose softmax is saved')
...
def main(unused_argv):
  ...
  raw_save_dir = os.path.join(
      FLAGS.vis_logdir, FLAGS.folder_name)
...
if __name__ == '__main__':
  ...
  flags.mark_flag_as_required('purpose')
  tf.app.run()
