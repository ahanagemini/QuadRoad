...
flags.DEFINE_string('train_loss', '', 'The loss used for training')
...
flags.DEFINE_integer('save_interval_steps', 5000,
...
def _build_deeplab(iterator, outputs_to_num_classes, ignore_label):
  ...
  elif FLAGS.train_loss == "dice":
    for output, num_classes in six.iteritems(outputs_to_num_classes):
      train_utils.add_dice_loss_for_each_scale(
          outputs_to_scales_to_logits[output],
          samples[common.LABEL],
          num_classes,
          ignore_label,
