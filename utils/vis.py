...
for tile in tiles:
    rgb = misc.imread(base_dir+"/test_rgb/" + tile + ".png")
    hght_pred = misc.imread(base_dir+"/test_pred_hght/" + tile + ".png")
    pred_17_4c = misc.imread(base_dir+"/pred_17_4c/" + tile + ".png")
    pred_17_1_pred = misc.imread(base_dir+"/test_pred_17_1/" + tile + ".png")
    rgb_pred = misc.imread(base_dir+"/test_pred_rgb/" + tile + ".png")
    ...
    hght_pred_3[:,:,0] = hght_pred
    hght_pred_3[:,:,1] = hght_pred
    hght_pred_3[:,:,2] = hght_pred
    ...
    r1 = numpy.concatenate((rgb_pad,annot_3,rgb_pred_3, pred_17_4c_pred_3),axis=1)
    r2 = numpy.concatenate((hght_pred_3,hs_pred_3,pred_17_1_pred_3, annot_17_3),axis=1)
    to_save = numpy.concatenate((r1,r2), axis=0)
    print(to_save.shape)
    misc.toimage(to_save, cmin=0, cmax=255).save(base_dir+"/to_view/" + tile + ".png")
